            ...
            <form className="mt-4">
              <div className="mb-4">
                ...
                <input
                  ...
                  value={username}
                  onChange={(e) =>
                    dispatch(handleOnChange("username", e.target.value))
                  }
                  className="border border-gray-300 dark:border-none dark:text-white dark:bg-darkInput bg-gray-50 appearance-none  rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  type="text"
